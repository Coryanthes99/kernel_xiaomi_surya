...
LATEST_COMMIT="[$COMMIT_POINT](https://github.com/Coryanthes99/kernel_xiaomi_surya/commit/$CHEAD)"
LOGS_URL="[See Circle CI Build Logs Here](https://circleci.com/gh/Coryanthes99/kernel_xiaomi_surya/$CIRCLE_BUILD_NUM)"
